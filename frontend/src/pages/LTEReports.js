...
const LTEReports = () => {
  ...
  return (
    <div className="reports-page">
      ...
      {/* Availability and Accessibility KPIs Section */}
        ...
        <div style={{ 
          ...
          <div className="content-header" style={{ marginTop: '0' }}>
            <h3 style={{ fontSize: '1.5rem', color: '#1f2937', marginBottom: '0.5rem' }}>
              Availability and Accessibility KPIs
            </h3>
            <p className="content-subtitle" style={{ fontSize: '0.875rem' }}>
              Cell availability metrics and E2E connection establishment success rates
            </p>
          </div>
      ...
      {/* Mobility and Retainability KPIs Section */}
      {visibleSections >= 2 && !kpiLoading && !kpiError && kpiData.length > 0 && (
        <div style={{ 
          ...
          <div className="content-header" style={{ marginTop: '0' }}>
            <h3 style={{ fontSize: '1.5rem', color: '#1f2937', marginBottom: '0.5rem' }}>
              Mobility and Retainability KPIs
            </h3>
            <p className="content-subtitle" style={{ fontSize: '0.875rem' }}>
              Handover success metrics and service retainability performance
            </p>
          </div>
      ...
      {visibleSections >= 4 && !loading && !error && (top20Sites.length > 0 || bottom20Sites.length > 0) && (
        <div style={{ 
          backgroundColor: '#ffffff', 
          borderRadius: '12px', 
          padding: '2rem', 
